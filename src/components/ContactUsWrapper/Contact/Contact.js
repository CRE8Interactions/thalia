            ...
            <Card body className={`${styles.card} card--light card-sm`}>
                <Row className='grid-container gx-md-4'>
                    <Col xs={12} md={6} lg={4}>
                        ...
                        <a href="https://www.google.com/maps/dir/43.4267291,-79.7409268/thalia+hall/@42.3859073,-88.9762437,6z/data=!3m1!4b1!4m9!4m8!1m1!4e1!1m5!1m1!1s0x880e2cffdb62b721:0x9a4a94db5d09cf36!2m2!1d-87.6575089!2d41.8576924?entry=ttu" target="_blank" className='btn btn-outline-light mt-2 w-100'>Go to Google Maps</a>
                    </Col>
